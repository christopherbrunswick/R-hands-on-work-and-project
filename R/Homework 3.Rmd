...
# 4. Use the [ and : operators to access the temperature of the 
# first three cities on the list.

temp[1:3]

# 5. Use the [ operator to access the temperature of Paris and 
# San Juan.
...
# 7. Create a vector containing all the positive odd 
# numbers smaller than 100.

seq(1, 100, 2)

# 8. Create a vector of numbers that starts at 6, does not pass 55, 
# and adds numbers in increments of 4/7: 6, 6 + 4/7, 6 + 8/7, and so 
# on. How many numbers does the list have? Hint: use seq and length.
...
# R defaults to numeric and to force an integer, you need to add 
# the letter L. Confirm that the class of 1L is integer.
